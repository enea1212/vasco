    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: selected ? AppColors.primaryMid : AppColors.surface,
    ...
    return Column(
      ...
      children: [
        ...
        const Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('18', style: TextStyle(fontSize: 12, color: AppColors.textHint)),
            Text('60', style: TextStyle(fontSize: 12, color: AppColors.textHint)),
          ],
        ),
      ],
    );
    ...
    return Column(
      ...
      children: [
        ...
        const Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('5 km', style: TextStyle(fontSize: 12, color: AppColors.textHint)),
            Text('150 km', style: TextStyle(fontSize: 12, color: AppColors.textHint)),
          ],
        ),
      ],
    );
